...
struct ALogger
{
  ...
  template <typename T> ALogger &w(std::string , T ) { /* do nothing */ return *this; }
  template <typename T> ALogger &wc(T ) { /* do nothing */  return *this; }
  template <typename T> ALogger &wc(std::string , T ) { /* do nothing */ return *this; }
};
#endif
