...
private:
  ...
  /**
   * @brief _changeable_dims contains axes of dimensions which is highly likely to be changed
   *        (case 2 below)
   *
   ...
   *                - This means that shape.dim(k) is treated as 1 but it is highly likely
